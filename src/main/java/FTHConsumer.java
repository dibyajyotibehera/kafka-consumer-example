...
public class FTHConsumer {
    String bootstrapServers ;
    String groupId ;
    String topics ;
    Properties props = new Properties();

    public FTHConsumer(String bootstrapServers, String groupId, String topics) {
    ...
    public void collectVegies() {
        ...
        veggies.forEach(veggie -> System.out.println("FTHConsumer: (key: " +
