...
public class BigBasketConsumer {
    String bootstrapServers ;
    String groupId ;
    String topics ;
    Properties props = new Properties();

    public BigBasketConsumer(String bootstrapServers, String groupId, String topics) {
    ...
    public void collectVegies() {
        ...
        veggies.forEach(veggie -> System.out.println("BBConsumer: (key: " +
